...
function FriendCard(props) {
    ...
    let cardElement =
        ...
        >
               ...
               <Box id='friendCard' bgcolor='#C6DF2D' display='flex' width='100%' height='100%'>
                        ...
                        <Box id='friendCard_name' sx={{textAlign:'center',position:'relative',width:'70%',height:'100%',paddingTop:'5%'}}> Name1</Box>
                        <IconButton size='90%'><DeleteOutlined/></IconButton>
